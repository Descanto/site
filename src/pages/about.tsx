...
const beliefs = [
  ...
  ["Honesty is a pricing model", "Descanto bills only while your desktop responds. Cold starts, snapshots, and uploads are on us — our slowness can never charge you, and overage is strictly opt-in."],
];
  ...
  return (
    <>
      <section className="mx-auto flex max-w-[1440px] flex-col gap-6 px-20 pt-22 pb-16 max-lg:px-8">
        <span className="text-xs font-semibold tracking-widest text-faint">ABOUT DESCANTO</span>
        ...
        <p className="max-w-180 text-[17px] leading-[1.65] text-graphite">
          Descanto builds that computer: a persistent cloud desktop that wakes in half a second and never forgets where it

...
A Descanto fork is a full copy of a running desktop — same tabs, same processes, same logins — created in about 225 milliseconds with roughly 1.4 MB of marginal RAM per clone.

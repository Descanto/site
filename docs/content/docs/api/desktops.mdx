...
| `idle_timeout_secs` | integer \| null | no | Seconds of guest idle time (from wake) before auto-hibernate; `0` means never. See [Concepts: TTL and auto-hibernate](/concepts/desktops-and-lifecycle#ttl-and-auto-hibernate). |
...
See [Concepts: env and setup_script](/concepts/desktops-and-lifecycle#env-and-setup_script)
...
[Concepts: TTL and auto-hibernate](/concepts/desktops-and-lifecycle#ttl-and-auto-hibernate).
...
[API reference: Operations](/api/operations) for its shape and
[Concepts: Operations](/concepts/operations) for the polling model.

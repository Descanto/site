---
title: Self-hosting
description: Running the Descanto stack yourself.
---

Descanto is early access, and the hosted API isn't public yet -- but the
control plane it's built on is a real, self-contained stack:
[`controld`](/api/overview), the leader-elected control plane that
